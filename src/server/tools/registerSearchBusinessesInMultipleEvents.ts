...
export function registerSearchBusinessesInMultipleEvents(
  ...
  server.registerTool(
    'search-exhibitors-across-multiple-events',
    {
      ...
      description:
        'Searches exhibitors across multiple events in batches. Returns resultsByEvent, eventsProcessed, failedEvents, errors. Required: eventIds (array). Optional: search, pageSize, pageIndex, sortField, asc, originCountryId, nationalCode, expoBusinessCategoryId, currencyId, language.',
      inputSchema: {
        eventIds: z
